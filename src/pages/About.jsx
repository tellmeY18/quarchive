export default function About() {
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-8 md:py-12">
      <h1 className="font-heading text-2xl md:text-3xl font-bold">About Quarchive</h1>

      <section className="mt-6 md:mt-8">
        <h2 className="font-heading text-lg md:text-xl font-semibold mb-3">What is Quarchive?</h2>
      ...
      <section className="mt-6 md:mt-8">
        <h2 className="font-heading text-lg md:text-xl font-semibold mb-3">How to Find Papers</h2>
        <p className="text-pyqp-text-light leading-relaxed">
      ...
      <section className="mt-6 md:mt-8">
        <h2 className="font-heading text-lg md:text-xl font-semibold mb-3">How to Contribute</h2>
        <p className="text-pyqp-text-light leading-relaxed">
      ...
      <section className="mt-6 md:mt-8">
        <h2 className="font-heading text-lg md:text-xl font-semibold mb-3">Why Archive.org?</h2>
        <p className="text-pyqp-text-light leading-relaxed">
      ...
      <section className="mt-6 md:mt-8">
        <h2 className="font-heading text-lg md:text-xl font-semibold mb-3">Open Source</h2>
        <p className="text-pyqp-text-light leading-relaxed">
      ...
      <section className="mt-6 md:mt-8">
        <h2 className="font-heading text-lg md:text-xl font-semibold mb-3">Attribution</h2>

export default function StepSource({ onSelectCamera, onSelectPdf }) {
  return (
    <div className="space-y-6">
      ...
      >
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-white/80 mt-0.5">Point your camera at the paper pages</p>
          </div>
        </div>
      </button>
      ...
      >
        <div className="flex items-center gap-3">
          <svg className="h-6 w-6 text-pyqp-muted" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
